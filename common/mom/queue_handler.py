...
class MessageQueueHandler:
    ...
    def _init_queues(self):
        ...
        try:
            ...
            # Importante: asegurarse que la cola existe
            channel.queue_declare(queue=OPERATION_QUEUE, durable=True)
            logger.info(f"Cola {OPERATION_QUEUE} declarada correctamente")
            ...
            logger.info(f"Exchange {RESULTS_EXCHANGE} declarado correctamente")
    ...
    def _start_consuming(self):
        ...
        try:
            ...
            # Asegurarnos que la cola existe antes de consumir
            channel.queue_declare(queue=OPERATION_QUEUE, durable=True)
            ...
            logger.info(f"Iniciando consumo de mensajes en cola {OPERATION_QUEUE}...")
    ...
    def _process_message_callback(self, ch, method, properties, body):
        ...
        try:
            ...
            # Publicar resultado en el exchange
            self._publish_result(operation_id, result)
    ...
    def publish_operation(self, a, b, operation_id=None):
        ...
        try:
            ...
            # Asegurar que existe la cola (muy importante)
            channel.queue_declare(queue=OPERATION_QUEUE, durable=True)
